...
export default function Header() {
    ...
    const navLinks = [{ name: "Private Equity", url: "/shares" }, {name:"DRHP-Filed", url:"/drhp-filed"}];
                    ...
                    <div className='flex '>
                        ...
                        <div className="flex items-center">
                            ...
                            <button
                                ...
                                type="button"
                                className="inline-flex items-center p-2 ml-1 text-sm text-gray-900 border-0 rounded-lg lg:hidden"
